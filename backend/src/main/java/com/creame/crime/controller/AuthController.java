...
import com.creame.crime.service.AuthService;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> policeLogin(@Valid @RequestBody LoginRequest request) {
        return ResponseEntity.ok(authService.policeLogin(request));
    }
}
